...
Give reviewers the intent, fixed diff, the callers it touches, applicable guidance, and assigned lenses. Distill plans and design docs into the brief rather than pointing reviewers at whole documents. Ask for actionable findings with concrete evidence, not style inventories.
